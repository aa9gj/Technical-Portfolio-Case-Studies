...
| [multiomics-canine-aging](projects/multiomics-canine-aging/) | Cross-modal aging biology analysis | R, Quarto, Seurat, SCTransform, DESeq2, limma/edgeR, mixOmics DIABLO, WGCNA, clusterProfiler, RaMP, fgsea, Python, SLURM | Multi-omics study decomposition, single-cell annotation, bulk RNA-seq DE, metabolomics pathway analysis, RNA/metabolite integration, figure reproducibility | Draft v1 |
